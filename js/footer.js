class MyFooter extends HTMLElement {
    connectedCallback() {
        ...
        <div class="container" bis_skin_checked="1">
            <div class="mailchim text-center" bis_skin_checked="1">
                ...
                <form id="mc-form" class="newsletter-form m-auto d-flex" data-toggle="validator" novalidate="true">
                    <input aria-label="Địa chỉ Email" type="email" class="form-control px-3" placeholder="Nhập địa chỉ email" name="EMAIL" required="" autocomplete="off" fdprocessedid="dm9fd">
                    <button class="btn btn-default ml-auto px-4" type="submit" aria-label="Nhận ưu đãi" name="subscribe" title="Nhận ưu đãi" fdprocessedid="6yedf">Nhận ưu đãi</button>
                </form>
                <div class="mailchimp-alerts " bis_skin_checked="1">
                    <div class="mailchimp-submitting" bis_skin_checked="1"></div>
                    <div class="mailchimp-success" bis_skin_checked="1"></div>
                    <div class="mailchimp-error" bis_skin_checked="1"></div>
                </div>
            ...
            <div class="copyright d-md-flex align-items-center py-3" bis_skin_checked="1">
                © Bản quyền thuộc về CÔNG TY CỔ PHẦN DU LỊCH VIỆT NAM
            </div>
        </div>
    </footer>
        `;
